export namespace main {
	...
	export class CompletionHistoryEntry {
	    // Go type: time
	    timestamp: any;
	    prefix: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new CompletionHistoryEntry(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.accepted_text = source["accepted_text"];
	...
	export class CompletionRequest {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.line_content = source["line_content"];
	        this.prefix = source["prefix"];
	...
	export class CompletionSuggestion {
	    ...
	    static createFrom(source: any = {}) {
	        return new CompletionSuggestion(source);
	    }
	...
	export class CompletionResponse {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.suggestions = this.convertValues(source["suggestions"], CompletionSuggestion);
	        this.model = source["model"];
	        this.latency_ms = source["latency_ms"];
